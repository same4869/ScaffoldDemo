    ...
    ***************************************************************************** */
        ...
        var _loop_1 = function (key) {
            ...
            /* istanbul ignore else */
            {
                ...
                if (isReservedAttribute(hyphenatedKey) || config.isReservedAttr(hyphenatedKey)) {
                    warn$2(
                        '"'.concat(hyphenatedKey, '" is a reserved attribute and cannot be used as component prop.'),
                        vm
                    );
                }
     ...
     */
    {
        strats.el = strats.propsData = function (parent, child, vm, key) {
            if (!vm) {
                warn$2(
                    'option "'.concat(key, '" can only be used during instance ') + 'creation with the `new` keyword.'
                );
            }
        ...
        for (i = 0, l = dirs.length; i < l; i++) {
            ...
            if (needRuntime) {
                ...
                res += '{name:"'
                    ...
                    .concat(dir.rawName, '"')
                    .concat(
                        dir.value ? ',value:('.concat(dir.value, '),expression:').concat(JSON.stringify(dir.value)) : ''
                    )
